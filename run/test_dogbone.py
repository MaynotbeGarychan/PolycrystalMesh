...
input_mesh_file_dir = r'C:\Users\Flab\Desktop\dogbone\dogbone_4.k'
input_ebsd_file_dir = r'C:\Users\Flab\Desktop\dogbone\input2.txt'
#
output_mesh_dir = r'C:\Users\Flab\Desktop\dogbone\output_solid_kishimoto.k'
euler_angle_file_dir = r'C:\Users\Flab\Desktop\dogbone\euler_angles_kishimoto.txt'
...
specimen_ebsd.points_set.scale_points_coordinates(1.05,'x')
specimen_ebsd.points_set.adjust_points_region_into_specimen_positions(shell_mesh.node_set)
#specimen_ebsd.points_set.translate_points_coodinates(-0.09,'y')
#specimen_ebsd.points_set.rotate_poinst_region(1)
...
specimen_ebsd.points_set.scale_points_coordinates(0.999,'y')
specimen_ebsd.points_set.translate_points_coodinates(0.025,'x')
...
map_elem_id_array = ebsd_to_mesh_indexing(specimen_ebsd,shell_mesh, (2,20))
...
solid_mesh = shell_mesh.drag_shell_to_solid(5, 0.06)
